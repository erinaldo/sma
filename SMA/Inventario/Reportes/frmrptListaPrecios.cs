...
{
    public partial class frmrptListaPrecios : Office2007Form
    {
        private List<cInventario> Lista;

        public frmrptListaPrecios()
        {
            InitializeComponent();
        }

        public frmrptListaPrecios(List<cInventario> Lista):this()
        {
            this.Lista = Lista;
        }
        private void frmrptListaPrecios_Load(object sender, EventArgs e)
        {
