...
{
    public partial class frmrptDevolucion : Office2007Form
    {
        private Int32 FacturaID;

        public frmrptDevolucion()
        {
            InitializeComponent();
        }

        public frmrptDevolucion(Int32 FacturaID):this()
        {
            this.FacturaID = FacturaID;
        }

        private void frmrptDevolucion_Load(object sender, EventArgs e)
        {
