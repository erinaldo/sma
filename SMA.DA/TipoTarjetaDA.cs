...
namespace SMA.DA
{
    public static class TipoTarjetaDA
    {
        public static List<cTipoTarjeta> Listar()
        {
            ...
            try
            {
                ...
                using (SqlConnection Conn = new SqlConnection(cConexion.CadenaConexion()))
                {
                    ...
                    string StoreProc = "uspListarTipoTarjeta";
                    ...
                    List<cTipoTarjeta> Lista = new List<cTipoTarjeta>();
                    while (Reader.Read())
                    {
